...
function Navbarleiste({onClick1,onClick2,onClick3}) {
  return (
    ...
    <Container>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto">
          ...
          <NavDropdown title="Bezahlen" icon={<svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" class="bi bi-basket" viewBox="0 0 16 16">
...
<h5 className="item1" onChange={onClick1}></h5>
<h5 className="item2" onChange={onClick2}></h5>
<h5 className="item3" onChange={onClick3}></h5>
